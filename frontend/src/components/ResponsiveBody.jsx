...
return(
    ...
    sx={{
        ...
        <Container maxWidth="false" className="section-buscar" sx={{
            ...
            <Typography color={"whitesmoke"}>Bienvenido a PORTAL SONORO! </Typography>
            <Typography color={"whitesmoke"}>Encuentra el equipamiento perfecto para ti</Typography>
            <SearchBar maxWidth="733px"/>
        </Container>

        <Container maxWidth="false" className="section-categorias" sx={{
            width: "100vw",
            height: "300px",
        }}>
        ...
        <Container maxWidth="false" className="section-recomendados" sx={{
            width: "100vw",
            height: "300px",
        }}>
